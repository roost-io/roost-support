...
CREATE TABLE IF NOT EXISTS `test_gpt` (
  ...
  `ui_test_info` TEXT NULL,
  `trigger_events` TEXT NULL,
  `created_on` TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
  `updated_on` TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `deleted` SMALLINT NOT NULL DEFAULT 0,
  `test_timeout` FLOAT NOT NULL DEFAULT 1,
  `webhook_error` TEXT NULL,
...
CREATE TABLE IF NOT EXISTS `license_use_trail` (
  ...
  `user_id` VARCHAR(45) NULL,
  `device_id` VARCHAR(100) NULL,
  `license_validation` ENUM("Success", "Failed") NULL,
  PRIMARY KEY (`id`)
)
ENGINE = InnoDB
DEFAULT CHARACTER SET = 'utf8';
...
CREATE TABLE IF NOT EXISTS `ai_model_content_hash` (
  ...
  `content_text` MEDIUMTEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- -----------------------------------------------------
-- Table `knowledge_base_data`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `knowledge_base_data` (
  `id` VARCHAR(45) NOT NULL,
  `knowledge_base_id` VARCHAR(45) NULL,
  `data_source_id` VARCHAR(45) NULL,
  `client_token` VARCHAR(45) NOT NULL,
  `name` VARCHAR(255) NOT NULL,
  `service_role` VARCHAR(255) NOT NULL,
  `data_source_configuration` TEXT NOT NULL,
  `knowledge_base_configuration` TEXT NOT NULL,
  `storage_configuration` TEXT NOT NULL,  
  `aws_credentials` TEXT NOT NULL,
  ...
  `deleted` SMALLINT NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`),
  CONSTRAINT `fk_knowledge_base_data_user_id`
    FOREIGN KEY (`user_id`)
    REFERENCES `user` (`id`)
    ON UPDATE CASCADE
)
...
-- -----------------------------------------------------
-- Table `test_gpt_audit`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `test_gpt_audit` (
  `id` VARCHAR(45) NOT NULL,
  ...
  `last_event_id` VARCHAR(45) NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `fk_test_audit_user_id`
    FOREIGN KEY (`user_id`)
    REFERENCES `user` (`id`)
    ON UPDATE CASCADE,
  CONSTRAINT `fk_test_audit_test_id`
    FOREIGN KEY (`test_id`)
    REFERENCES `test_gpt` (`id`)
    ON UPDATE CASCADE
)
ENGINE = InnoDB
DEFAULT CHARACTER SET = 'utf8';
...
CREATE TABLE IF NOT EXISTS `admin_dashboard` (
  ...
  `ai_provider` VARCHAR(45) NOT NULL,
  `ai_model` VARCHAR(100) NULL,
  `trigger_source` VARCHAR(100) NOT NULL DEFAULT 'ui',
  `api_calls_to_ai` INT NOT NULL DEFAULT 0,
